 ...
 */
package practice062.labs.pm.data;
...
public class Product {
    ...
    public Product applyRating(Rating newRating){
        return new Product(this.getId(), this.getName(), this.getPrice(), newRating);
    }

    @Override
    public String toString() {
        return  "id=" + id + ", name=" + name + ", price=" + price + ", rating=" + rating.getStarts() ;
    }
