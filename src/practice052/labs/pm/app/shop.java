 ...
 */
package practice052.labs.pm.app;

import java.math.BigDecimal;
import practice052.labs.pm.data.Product;
import practice052.labs.pm.data.Rating;
 ...
 * 
 * Refers: Practice 5-2: Add Custom Constructors to the Product Class			
 */
public class shop {
    ...
    public static void main(String[] args) {
       ...
       Product p2 = new Product(102, "coffee", BigDecimal.valueOf(1.99), Rating.FOUR_STARTS);
       Product p3 = new Product(103, "Cake", BigDecimal.valueOf(3.99), Rating.FIVE_STARTS);
