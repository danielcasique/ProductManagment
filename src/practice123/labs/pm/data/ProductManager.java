 ...
 */
package practice123.labs.pm.data;
...
public class ProductManager {
    ...
    private ResourceBundle config = ResourceBundle.getBundle("practice123.labs.pm.data.config");
...
//        );
    ...
    private static class ResourceFormatter {
        ...
        private ResourceFormatter(Locale locale) {
            this.locale = locale;
            resources = ResourceBundle.getBundle("practice123.labs.pm.data.resources", locale);
