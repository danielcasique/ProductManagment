 ...
 */
package practice064.labs.pm.app;

import java.math.BigDecimal;
import java.time.LocalDate;
import practice064.labs.pm.data.Drink;
import practice064.labs.pm.data.Food;
import practice064.labs.pm.data.Product;
import practice064.labs.pm.data.Rating;
...
public class shop {
    ...
    public static void main(String[] args) {
        Product p1 = new Drink(101, "Tea", BigDecimal.valueOf(1.99), Rating.THREE_STARTS);
        ...
        Product p4 = new Food(105, "Cookie", BigDecimal.valueOf(3.99), Rating.TWO_STARTS, LocalDate.now());
